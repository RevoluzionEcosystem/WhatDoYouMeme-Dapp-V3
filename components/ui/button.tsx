...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-300",
    {
        variants: {
            variant: {
                basic:
                    "bg-transparent text-foreground border border-transparent shadow hover:text-primary",
                primary:
                    "bg-primary text-primary-foreground border border-transparent shadow hover:bg-foreground hover:text-background",
                box:
                    "bg-transparent text-foreground border border-primary shadow hover:bg-foreground hover:text-background hover:border-transparent",
                tooltip:
                    "bg-transparent text-foreground shadow-sm hover:text-primary",
                default:
