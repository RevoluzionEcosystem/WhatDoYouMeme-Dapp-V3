...
export default function Header() {
    ...
    return (        
        <header className="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-background border-b text-sm py-2.5 sm:py-4 lg:pl-64">
            <nav className="flex basis-full items-center w-full mx-auto px-4 sm:px-6 md:px-8" aria-label={terms.global}>
                <div className="mr-5 lg:mr-0 lg:hidden">
                    <a className="flex-none text-xl font-semibold text-primary" href="/home" aria-label={general.project_acronym}>
