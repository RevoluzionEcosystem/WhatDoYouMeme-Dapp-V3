...
import GoStakingButton from "../button/go-staking"
    ...
    return (
        <TabsContent value="staking">
            <Card>
                <CardHeader>
                    <CardTitle>
                        {`${home["content"]["staking"].headline}`}
                    </CardTitle>
                    <CardDescription>
                        {`${home["content"]["staking"].subheadline}.`}
                    </CardDescription>
                </CardHeader>
